            ...
            <div class="w-full lg:w-6/12 px-4">
                <div class="flex flex-wrap items-top mb-6">
                    ...
                    <div class="w-full lg:w-4/12 px-4">
                        <span class="block uppercase text-blueGray-500 text-sm font-semibold mb-2">Catgory</span>
                        <ul class="list-unstyled">
                            @foreach ($category as $item)
                                <li>
                                    <a class="text-blueGray-600 hover:text-blueGray-800 font-semibold block pb-2 text-sm"
                                        href="{{ route('home.search', $item->id) }}">{{ $item->genre }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
            ...
            <div class="w-full md:w-4/12 px-4 mx-auto text-center">
                <div class="text-sm text-blueGray-500 font-semibold py-1">
                    Copyright © <span id="get-current-year">2021</span><a href="#"
                        class="text-blueGray-500 hover:text-gray-800" target="_blank"> FlashFlow by
                        <a href="#" class="text-blueGray-500 hover:text-blueGray-800">Apple baby</a>.
                </div>
            </div>
        </div>
    </div>
